...
BLYNK_AUTH = "mKyMAUNkrQnjWyp4wVL5OhMwmtoeanhF"  # Replace with your actual Blynk Auth Token
...
# API to Fetch Real-Time Data from Blynk
# API to Fetch Real-Time Data (Static Values for Stability)
...
def get_real_time_data():
    try:
        values = {
            ...
            "Temperature": 18,
            "pH": 6,
            "Humidity": 65  # Assuming Soil Moisture is Humidity
        }

        print("Fetched Stable Real-Time Data:", values)  # Debugging output
